...
export function CalendarEventSpan({ data }: EventProps<CalendarEvent>) {
  ...
  return (
    <div
      className='absolute rounded-sm left-4 right-4 bg-blue-400 text-white font-semibold text-sm z-[2] px-1'
      style={{
        minHeight: `${height}px`,
        top: `${top}px`
      }}
