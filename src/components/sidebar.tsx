...
export function SideBar() {
  ...
  return (
    <div
      ...
      className='w-full h-[calc(100%-40px)] my-[20px] rounded-tr-[50px] rounded-br-[50px] flex flex-col items-center justify-between bg-white border-[1px] border-s-none border-[#D0D7DE] p-5'
    >
